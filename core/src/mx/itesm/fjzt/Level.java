...
public class Level extends Pantalla {
    //Mapa
    ...
    private void cargarMapa() {
        ...
        manager.load("ProjectOdizeyTest3.tmx",TiledMap.class);
        manager.finishLoading(); //BLOQUEA la app para terminar la carga
        mapa = manager.get("ProjectOdizeyTest3.tmx");
